...
public interface IStudentAssociativeArray {
     ...
     * @return true if the surname exists as a key in the associative array
     */
     ...
     * @return true if the Student object 'student' exists as a value in the associative array
     */
     ...
     * @pre true
     * @return true if the associative array is empty
     */
